...
/**
 * Represents an implementation of {@link BaiduUidGenerator}
 *
 ...
 * @author yutianbao
 */
public class DefaultUidGenerator implements BaiduUidGenerator, InitializingBean {
    ...
    protected String epochStr = "2022-01-13";
    protected long epochSeconds = TimeUnit.MILLISECONDS.toSeconds(1642003200000L);
